    ...
    <div className="flex flex-col w-full bg-[#0b314d] overflow-hidden relative">
      <div className="relative w-full h-[6.5rem] md:h-[15rem] lg:h-[20rem] overflow-hidden">
        ...
        <div className="absolute inset-x-0 top-0 z-[25] pointer-events-none flex justify-center pt-0.5 px-1">
          <p
            className="text-[6px] md:hero-header-tight md:hero-mashallah font-kufi text-[#f3e5bc] font-normal opacity-60 md:opacity-100 drop-shadow-[0_1px_2px_rgba(0,0,0,0.9)]"
            dir="rtl"
          >
            {HERO_MASHALLAH_AR}
          </p>
        ...
        <div className="flex flex-col items-center gap-0.5 md:gap-1 mt-0.5">
          <h1
            className={`text-fluid-reset text-[#D4AF37] tracking-tight leading-tight font-black ${locale === "ur"
                ? "urdu-text text-[21px] md:text-[1.5rem] lg:text-[1.7rem] whitespace-nowrap"
                : locale === "fa"
                  ? "font-persian text-[1.2rem] md:text-[1.4rem] lg:text-[1.5rem] max-w-[92vw]"
                  : "font-hero-en text-[1.2rem] md:text-[1.4rem] lg:text-[1.5rem]"
              }`}
          >
            {dict.hero.name}
          </h1>
          <p
            className={`hero-header-tight hero-roles text-white/90 font-normal tracking-tight border-t border-[#D4AF37]/25 pt-0.5 md:pt-1 mt-0.5 md:mt-1 flex flex-wrap justify-center content-center gap-x-0.5 gap-y-0 max-w-[40rem] px-0.5 text-[6.5px] md:text-[12px] ${locale === "en"
