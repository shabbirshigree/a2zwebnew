...
export default function UltimateAboutPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f8f9fa] overflow-x-hidden font-sans" dir="ltr">
      ...
      <section className="container mx-auto px-4 py-10 relative z-10" dir="ltr">
        ...
        <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto items-stretch">
          ...
          {/* Right Side: Founder Grid & Media Section */}
          <div className="lg:w-2/3 w-full flex flex-col gap-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center">
              {localizedFounderItems.map((item, i) => {
                ...
                const CardContent = (
                  <div className="bg-gradient-to-br from-[#0a1f30] to-[#1c3b57] border border-[#D4AF37]/50 rounded-2xl p-4 md:p-5 hover:bg-gradient-to-br hover:from-[#D4AF37] hover:to-[#B8860B] transition duration-300 group transform hover:scale-105 shadow-lg flex flex-col items-center justify-center h-full min-h-[140px] md:min-h-[180px] w-full text-center cursor-pointer">
                    <div className="text-3xl text-[#D4AF37] mb-3 group-hover:text-[#0a1f30] transition">{item.icon}</div>
                    <h3 className="font-bold text-white group-hover:text-[#0a1f30] text-[11px] md:text-sm mb-1 leading-tight text-center w-full break-words">{title}</h3>
                    <p
                      dir="ltr"
                      className="hidden md:block text-gray-400 group-hover:text-[#0a1f30]/90 text-[10px] tracking-normal font-sans text-center w-full max-w-[90%] mx-auto leading-snug px-1"
                    >
                      {item.desc}
                    </p>
                  </div>
            ...
            {/* 📺 Media & Electronic Journalism Section (Now under Founder Grid) */}
            <div className="mt-2">
              <h3 className="text-xl md:text-2xl font-bold text-[#0f4c75] mb-6 text-center border-b-2 border-[#D4AF37] w-fit mx-auto pb-1">Media & Electronic Journalism</h3>
