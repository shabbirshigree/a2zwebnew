export const ghaziData = {
  ...
  news: {
    ...
    paragraph2: "Hujjat al-Islam wal-Muslimeen Muhammad Abbas al-Husseini has recently passed away. May Allah grant him the highest station in Jannat al-Firdaus in return for his religious services. Ameen.",
  ...
  award: {
    ...
    videoText: "Haji Shabbir Ahmed Shigri said this honor is not just for him, but also for those who support him and remember him in their prayers. He expressed deep gratitude to Ghazi Abbas (AS) and Imam Mahdi (AJ) for this blessing and thanked Allah for these mercies. He prayed to be able to fulfill this responsibility with sincerity. After receiving this important award, congratulations poured in from many organizations and friends.",
    images: [
