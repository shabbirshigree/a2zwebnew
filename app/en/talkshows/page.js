...
export default function TalkshowsPageEN() {
            ...
            return (
                <div key={i} className="relative group rounded-xl overflow-hidden border-2 border-white/20 hover:border-[#D4AF37] shadow-lg cursor-pointer bg-black aspect-video" onClick={() => setActiveVideo(videoId)}>
                    ...
                    <div className="absolute bottom-0 w-full bg-gradient-to-t from-black via-black/80 to-transparent p-3 text-center">
                        <h4 className="text-white font-bold text-xs md:text-sm leading-tight">{vid.title}</h4>
                    </div>
                </div>
            );
        });
    ...
    return (
        <div className="min-h-screen bg-[#f8f9fa] text-gray-800 font-sans">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="flex justify-center mt-8 border-t border-white/20 pt-8">
                        ...
                        >
                            ...
                            Visit Noor Productions YouTube Channel For Complete Videos
                        </a>
                    </div>
            ...
            {/* Section 5: Follow Us (Social Media) */}
            <section className="container mx-auto px-4 pb-16 pt-10">
                <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#0b314d] to-[#0f4c75] rounded-3xl p-8 md:p-12 text-white border-2 border-[#D4AF37] shadow-2xl text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-sm md:text-xl mb-8 opacity-90 font-light">Connect with us on social media for all latest updates and exclusive content</p>
                        ...
                        <div className="flex flex-wrap justify-center gap-4 md:gap-8 items-center">
                            ...
                            <a href="https://x.com/shigri41215" target="_blank" className="bg-white/10 p-3 md:p-4 rounded-full hover:bg-white hover:scale-110 transition duration-300 group shadow-lg"><FaXTwitter className="text-2xl md:text-4xl text-white group-hover:text-white/70" /></a>
                            <a href="https://www.tiktok.com/@noorproductions786" target="_blank" className="bg-white/10 p-3 md:p-4 rounded-full hover:bg-white hover:scale-110 transition duration-300 group shadow-lg"><FaTiktok className="text-2xl md:text-4xl text-white group-hover:text-white/70" /></a>
                        </div>
                    </div>
                </div>
            </section>
