...
export default function EnglishArticlesPage() {
  ...
  const getArticleUrl = (article) => {
    ...
    return `${window.location.origin}/en/article?read=${encodeURIComponent(article.id)}`;
      ...
      <div className="container mx-auto px-4 pb-16 pt-4">
        ...
        {!selectedArticle ? (
          ...
          <>
            ...
            {/* 🔍 Search Bar & Filters (International Level Design) */}
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-6 border border-[#D4AF37]/20">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-center">
                  ...
                  <div className="relative w-full md:w-1/2 group">
                    ...
                    <FaSearch className="absolute left-4 top-1/2 -translate-y-1/2 text-[#D4AF37] group-focus-within:scale-110 transition-transform" />
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-6 py-4 bg-gray-50 border-2 border-gray-100 rounded-xl focus:border-[#D4AF37] focus:ring-0 outline-none transition-all text-lg font-bold"
                ...
                {filteredArticles.map((article, index) => (
                  ...
                  >
                    ...
                    <div className="h-56 overflow-hidden bg-gray-100 relative">
                      ...
                      <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md text-[#0b314d] text-xs font-bold px-4 py-1.5 rounded-full shadow-lg border border-[#D4AF37]/30">
