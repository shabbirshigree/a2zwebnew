    ...
    <main className="min-h-screen bg-[#f8f9fa] text-gray-800 relative overflow-hidden font-amiri">
      ...
      <div className="relative z-10 container mx-auto px-4 pt-16 pb-8 text-center">
        <div className="bg-white/80 backdrop-blur-md border-2 border-[#D4AF37] rounded-[2rem] p-6 md:p-10 shadow-xl max-w-5xl mx-auto animate-float">
           ...
           <h1 className="text-2xl md:text-5xl font-extrabold text-[#0f4c75] mb-2 font-extra-bold">حاجی شبیر احمد شگری — خادم امام رضا</h1>
           <h2 className="text-lg md:text-2xl text-[#D4AF37] font-bold">سفری معنوی در راه ایمان، خدمت و تکلیف فرهنگی</h2>
           ...
           <div className="text-gray-900 text-sm md:text-xl leading-loose text-justify md:text-center max-w-4xl mx-auto space-y-4 font-extra-bold" dir="rtl">
             <p className="font-extrabold text-[#0f4c75] text-lg md:text-2xl">«جایی که پادشاهان و امراء سر فرود می‌آورند، این محفل محترم است...»</p>
             <p>به صفحه اختصاصی خدمت و مأموریت معنوی حرم امام رضا (ع) خوش آمدید. این صفحه سفر باعظمت حاجی شبیر احمد شگری را نشان می‌دهد در حالی که میراث زیبا و عشق دینی و خدمت فرهنگی را نمایندگی می‌کند.</p>
             <p className="bg-[#f8f9fa] p-4 rounded-xl border-l-4 border-[#D4AF37] shadow-sm"><strong className="text-[#0f4c75] text-lg">نور نخست: «ضریح نور» (۲۰۰۲)</strong><br />در سال ۲۰۰۲، او ساخت مبارک ضریح کنونی را مستندسازی کرد. در ۲۰۱۱، آستان قدس رضوی او را با عنوان <strong className="text-[#D4AF37]">«خادم امام رضا»</strong> تجلیل کرد.</p>
           </div>
        </div>
      </div>
      ...
      <div id="tabarrukat" className="relative z-10 container mx-auto px-4 py-10 bg-[#D4AF37]/10 rounded-[3rem]">
         <div className="text-center mb-8"><h2 className="text-2xl md:text-3xl font-extrabold text-[#8a6200] border-b-4 border-white inline-block pb-2">پخش تبرکات</h2></div>
      ...
      {liveParticipationVideos.length > 0 && (
          <div id="liveParticipations" className="relative z-10 container mx-auto px-4 py-10 bg-[#0f4c75]/5 border-y-4 border-[#D4AF37] my-8">
             <div className="text-center mb-8"><h2 className="text-2xl md:text-3xl font-extrabold text-[#0f4c75] border-b-4 border-[#D4AF37] inline-block pb-2">مشارکت در برنامه‌های زنده</h2></div>
      ...
      <div id="manqabat" className="relative z-10 container mx-auto px-4 py-10">
         <div className="text-center mb-8"><h2 className="text-2xl md:text-3xl font-extrabold text-[#0f4c75] border-b-4 border-[#D4AF37] inline-block pb-2">منقبت‌ها و نعت‌ها</h2></div>
         <div className="grid grid-cols-1 md:grid-cols-3 gap-4" dir="rtl">
      ...
      <div id="services" className="relative z-10 container mx-auto px-4 py-12 bg-white">
         <div className="text-center mb-10"><h2 className="text-2xl md:text-3xl font-extrabold text-[#0f4c75] border-b-4 border-[#D4AF37] inline-block pb-2">خدمات آنلاین و وبینار</h2></div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 text-center bg-[#f8f9fa] mt-10 border-t-2 border-[#D4AF37]/30">
         <h2 className="text-2xl font-bold text-[#0f4c75] mb-8 border-b-2 border-[#D4AF37] inline-block pb-2">بیشتر کاوش کنید و مطالعه کنید</h2>
         <div className="flex flex-col md:flex-row justify-center gap-6 max-w-5xl mx-auto">
            ...
            <Link href="/en/article" className="flex-1 bg-[#D4AF37] text-white p-5 rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all flex items-center justify-center gap-3 font-bold text-lg">
              <FaPenNib size={28} /> تمام مقالات و یادداشت‌ها
            </Link>
         </div>
      </div>
