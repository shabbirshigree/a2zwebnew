...
import { 
  ...
  FaChevronLeft, FaLaptop, FaClock, FaCalendarCheck, FaMosque, FaShoppingBag
} from "react-icons/fa";
    ...
    <main className="min-h-screen bg-[#f8f9fa] text-gray-800 relative overflow-hidden font-amiri">
      ...
      <div className="relative z-10 container mx-auto px-4 pt-16 pb-8 text-center">
        <div className="bg-white/80 backdrop-blur-md border-2 border-[#D4AF37] rounded-[2rem] p-6 md:p-10 shadow-xl max-w-5xl mx-auto animate-float">
           ...
           <h1 className="text-2xl md:text-5xl font-extrabold text-[#0f4c75] mb-2 font-extra-bold">Hajji Shabbir Ahmad Shugri — Servant of Imam Reza</h1>
           <h2 className="text-lg md:text-2xl text-[#D4AF37] font-bold">A Spiritual Journey in the Path of Faith, Service and Cultural Duty</h2>
           ...
           <div className="text-gray-900 text-sm md:text-xl leading-loose text-justify md:text-center max-w-4xl mx-auto space-y-4 font-extra-bold">
             <p className="font-extrabold text-[#0f4c75] text-lg md:text-2xl">"Where kings and nobles bow their heads, this honorable gathering..."</p>
             <p>Welcome to the dedicated page of service and spiritual mission at the Holy Shrine of Imam Reza (AS). This page showcases the magnificent journey of Hajji Shabbir Ahmad Shugri as he represents the beautiful heritage of religious love and cultural service.</p>
             <p className="bg-[#f8f9fa] p-4 rounded-xl border-l-4 border-[#D4AF37] shadow-sm"><strong className="text-[#0f4c75] text-lg">First Light: "Zarih-e-Noor" (2002)</strong><br />In 2002, he documented the construction of the current blessed shrine. In 2011, Astan Quds Razavi honored him with the title of <strong className="text-[#D4AF37]">"Servant of Imam Reza"</strong>.</p>
           </div>
        </div>
      </div>
      ...
      <div id="docs" className="relative z-10 container mx-auto px-4 py-10">
         <div className="text-center mb-8"><h2 className="text-2xl md:text-3xl font-extrabold text-[#0f4c75] border-b-4 border-[#D4AF37] inline-block pb-2">Documentaries & Special Videos</h2></div>
      ...
      <div id="tabarrukat" className="relative z-10 container mx-auto px-4 py-10 bg-[#D4AF37]/10 rounded-[3rem]">
         <div className="text-center mb-8"><h2 className="text-2xl md:text-3xl font-extrabold text-[#8a6200] border-b-4 border-white inline-block pb-2">Blessed Items Distribution</h2></div>
      ...
      <div id="programs" className="relative z-10 container mx-auto px-4 py-10">
         <div className="text-center mb-8"><h2 className="text-2xl md:text-3xl font-extrabold text-[#0f4c75] border-b-4 border-[#D4AF37] inline-block pb-2">Live Shrine and Pilgrimage Programs</h2></div>
      ...
      <div id="manqabat" className="relative z-10 container mx-auto px-4 py-10">
         <div className="text-center mb-8"><h2 className="text-2xl md:text-3xl font-extrabold text-[#0f4c75] border-b-4 border-[#D4AF37] inline-block pb-2">Manqabats and Naats</h2></div>
         <div className="grid grid-cols-1 md:grid-cols-3 gap-4" dir="rtl">
      ...
      <div id="services" className="relative z-10 container mx-auto px-4 py-12 bg-white">
         ...
         <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-2xl border-2 border-[#D4AF37] overflow-hidden flex flex-col md:flex-row" dir="rtl">
            ...
            <div className="md:w-1/2 p-8 flex flex-col justify-center space-y-4">
               <h3 className="text-2xl font-extrabold text-[#0f4c75] leading-tight">The Husseini Path and the 12-Day Battle of Right vs Wrong</h3>
               <p className="text-gray-600 font-bold border-b pb-2">Special session held in collaboration with Astan Quds Razavi and Noor Productions.</p>
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 text-center bg-[#f8f9fa] mt-10 border-t-2 border-[#D4AF37]/30">
         <h2 className="text-2xl font-bold text-[#0f4c75] mb-8 border-b-2 border-[#D4AF37] inline-block pb-2">Explore More and Study</h2>
         <div className="flex flex-col md:flex-row justify-center gap-6 max-w-5xl mx-auto">
            ...
            <Link href="/en/article" className="flex-1 bg-[#D4AF37] text-white p-5 rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all flex items-center justify-center gap-3 font-bold text-lg">
              <FaPenNib size={28} /> All Articles and Notes
            </Link>
         </div>
      </div>
