...
const DESC_TRANSLATIONS = {
  ...
  "میزبانی۔": "Hosting.",
  "چینل۔": "Channel.",
  "وزیر بیت المال۔": "Minister of Awqaf.",
  "سیکرٹری اوقاف۔": "Secretary of Religious Endowments.",
  "حسن عسکری۔": "Hassan Askari.",
  "منظور وٹو۔": "Manzoor Watto.",
  "سابق وزیر تعلیم۔": "Former Education Minister.",
  "محسن نجفی مزار۔": "Mohsin Najafi shrine.",
  "اسپیکر جی بی۔": "GB Speaker.",
  "یادگار۔": "Memorable moment.",
  "حج بیت اللہ۔": "Hajj to the House of Allah.",
  "مدینہ منورہ۔": "Medina Munawarah.",
  "ایران کا سفر۔": "Journey to Iran.",
  "تاریخی مقام۔": "Historical site.",
  "سیاحت۔": "Tourism.",
  "خوبصورت نظارہ۔": "Beautiful scenery.",
  "رات کا منظر۔": "Night view.",
  "امام خمینیؒ ہاؤس۔": "Imam Khomeini's house.",
  "طبیعت پل۔": "Tabiat Bridge.",
  "اقبالؒ کی جائے پیدائش۔": "Allama Iqbal's birthplace.",
  "بین المذاہب ہم آہنگی۔": "Interfaith harmony.",
  "وحدت میٹنگ۔": "Unity meeting.",
  "بین المسالک اتحاد۔": "Inter-sect unity.",
  "میلاد مصطفیٰؐ۔": "Milad-un-Nabi.",
  "علمائے کرام کا اتحاد۔": "Gathering of religious scholars.",
};
