        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto bg-white/10 backdrop-blur-sm p-6 md:p-10 rounded-3xl border border-[#D4AF37]/40 shadow-2xl">
            ...
            <p className="text-body text-gray-100 leading-relaxed text-right md:text-justify mb-8">
              نورِ کربلا، نور پروڈکشنز کی ایک منفرد اور شاہکار دستاویزی سیریز ہے، جس کے پروڈیوسر حاجی شبیر احمد شگری ہیں۔ اس سیریز میں پہلی مرتبہ زیاراتِ مقدسہ کے ساتھ ساتھ کربلا کے مقامات کی مستند تفصیلات اور ان کے تاریخی پس منظر کو یکجا کیا گیا ہے۔ اپنی نوعیت کی اس پہلی پیشکش کا اعزاز نور پروڈکشنز کو حاصل ہے۔ ذیل میں موجود پلے لسٹ کے ذریعے آپ ان تمام ویڈیوز کا مشاہدہ کر سکتے ہیں۔
            </p>
            ...
            <div className="mt-6 flex justify-center">
              ...
              >
                ...
                نور کربلا کی تمام ویڈیوز دیکھنے کے لیے پلے لسٹ پر کلک کریں
              </a>
            </div>
          </div>
        </div>
