...
export default function GhaziAbbasClient() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 overflow-x-hidden rtl urdu-text" dir="rtl">
      <style>{`
        /* Ripple animation */
        @keyframes ripple {
      ...
      <section className="relative h-[380px] md:h-[420px] hero-gradient flex items-center justify-center text-white pb-6">
        ...
        <div className="relative z-10 px-4 w-full max-w-5xl mx-auto -mt-4 flex flex-col items-center justify-center text-center">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-center max-w-3xl text-sm sm:text-base md:text-xl lg:text-2xl opacity-100 font-extrabold leading-normal md:leading-relaxed px-2 mx-auto text-white font-extra-bold">
      ...
      <section className="container mx-auto px-4 -mt-10 relative z-20 pb-16">
        <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-xl p-6 md:p-12 border-t-8 gold-border">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-4 text-[#8b0000] mb-8 text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold mt-2 font-extra-bold">{ghaziData.intro.welcome}</h2>
          </div>
          <div className="text-lg md:text-xl leading-loose text-gray-800 text-justify font-extrabold font-extra-bold">
            {ghaziData.intro.text}
          </div>
          <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end md:justify-end">
            <p className="text-xl md:text-2xl font-extrabold text-[#8b0000] text-right font-extra-bold">{ghaziData.intro.author}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#3a0000] text-white relative">
        <div className="container mx-auto px-4">
          <h3 className="text-3xl md:text-5xl font-extrabold text-center text-[#D4AF37] mb-12 flex items-center justify-center gap-4 font-extra-bold">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-[#D4AF37]/50 relative">
              ...
              <p className="text-lg md:text-xl leading-loose text-gray-100 text-justify font-extrabold font-extra-bold">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h3 className="text-2xl md:text-3xl font-extrabold text-[#4a0000] leading-normal font-extra-bold">
                {ghaziData.news.headline}
              </h3>
              <p className="text-lg leading-relaxed text-gray-700 text-justify font-bold">{ghaziData.news.paragraph1}</p>
              <div className="bg-red-50 p-6 rounded-lg border-r-4 border-red-800 my-6">
                <p className="text-lg leading-relaxed text-gray-800 text-justify font-bold">{ghaziData.news.paragraph2}</p>
              </div>
            </div>
            <div
      ...
      <section className="py-16 bg-slate-100">
        <div className="container mx-auto px-4">
          <h3 className="text-3xl font-extrabold text-[#4a0000] text-center mb-10 flex items-center justify-center gap-3 font-extra-bold">
            <FaImages className="text-[#D4AF37]" /> تصاویرِ افتخار
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {ghaziData.award.images.map((img, i) => (
              ...
              >
                <img src={img} className="w-full h-full object-cover" alt="ایوارڈ تقریب" />
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-[#3a0000] text-white relative">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto bg-white/10 backdrop-blur-sm p-6 md:p-10 rounded-3xl border border-[#D4AF37]/40 shadow-2xl">
            <h3 className="text-2xl md:text-4xl font-extrabold text-center text-[#D4AF37] mb-6 flex items-center justify-center gap-3 font-extra-bold">
              <FaVideo /> نورِ کربلا — پلے لسٹ
            </h3>
            <p className="text-lg md:text-xl leading-loose text-gray-100 text-justify mb-8 font-bold">
              مجموعہ مستند «نورِ کربلا» اثری ماندگار از «نور پروڈکشنز» بہ پیشکش حاجی شبیر احمد شگری ہے۔ اس مجموعے میں پہلی بار مقاماتِ کربلا اور ان کی تاریخی تفصیلات کو جامع انداز میں پیش کیا گیا ہے۔ یہ منفرد منصوبہ نور پروڈکشنز کے ریکارڈ میں ایک سنہرا باب ہے، جس کی پلے لسٹ نیچے دیکھی جا سکتی ہے۔
            </p>
      ...
      <section className="py-16 bg-gradient-to-b from-[#1a0000] to-[#3a0000] text-white">
        <div className="container mx-auto px-4">
          <h3 className="text-xl md:text-3xl font-extrabold text-center text-[#D4AF37] mb-12 flex items-center justify-center gap-3 leading-relaxed max-w-5xl mx-auto font-extra-bold">
            <FaVideo className="shrink-0" /> حرم شاہِ وفا حضرت عباس علمدارؑ کے چند یادگار لمحات، حاجی شبیر احمد شگری کے کیمرے کی نظر سے
          </h3>
             ...
             {[ghaziData.extraVideos[0], ...ghaziData.ziyaratVideos.slice(0, 6), ...ghaziData.extraVideos.slice(1)].map((video, i) => (
              ...
              >
                ...
                <div className="p-4 bg-gradient-to-b from-black/90 to-black text-center min-h-[80px] flex items-center justify-center">
                  <h4 className="text-lg md:text-xl font-bold text-[#D4AF37] leading-relaxed">{video.title}</h4>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 bg-[#2a0000] border-t border-[#D4AF37]/20">
        <div className="container mx-auto px-4">
          <h3 className="text-2xl md:text-3xl font-extrabold text-center text-[#D4AF37] mb-10 flex items-center justify-center gap-3 font-extra-bold">
            <FaVideo className="text-xl" /> مختصر ویڈیو کلپس (Shorts)
          </h3>
            ...
            {[...ghaziData.shorts, ...ghaziData.ziyaratVideos.slice(6)].map((vid, i) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black/80 to-transparent">
                  <p className="text-[10px] md:text-xs text-white text-center line-clamp-2 leading-tight font-bold">{vid.title}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 bg-slate-50 border-t border-gray-200">
        <div className="container mx-auto px-4">
          <h3 className="text-3xl font-extrabold text-[#8b0000] text-center mb-10 flex items-center justify-center gap-3 font-extra-bold">
          ...
          <div className="max-w-5xl w-full h-full flex items-center justify-center" onClick={(e) => e.stopPropagation()}>
            <div className="relative w-full bg-black rounded-2xl overflow-hidden shadow-2xl border-2 border-[#D4AF37]">
              ...
              <div className="p-4 bg-gradient-to-b from-black/90 to-black text-center">
                <h4 className="text-lg md:text-xl font-bold text-[#D4AF37] mb-2">{selectedVideo.title}</h4>
                <p className="text-sm text-gray-300 opacity-80">بند کرنے کے لئے کہیں بھی کلک کریں</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="fixed bottom-6 left-6 z-50 flex items-center gap-3">
        ...
        <Link href="/home" className="w-12 h-12 md:w-14 md:h-14 bg-[#D4AF37] text-white rounded-full shadow-2xl hover:scale-110 transition-transform flex items-center justify-center border-4 border-white">
