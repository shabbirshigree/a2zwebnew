        ...
        <div className="min-h-screen bg-[#f8f9fa] text-gray-800 font-sans overflow-x-hidden">
            ...
            <section className="bg-gradient-to-b from-[#0b314d] to-[#0f4c75] text-white py-16 md:py-24 text-center relative border-b-8 border-[#D4AF37] shadow-2xl">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#D4AF37] drop-shadow-lg mb-6 urdu-text tracking-wide leading-tight">
                        {pageIntro.title}
                    </h1>
                    <h2 className="text-xl md:text-2xl text-[#fff7cc] font-light urdu-text tracking-widest mb-10">
                        {pageIntro.subtitle}
                    </h2>
                    ...
                    <div className="max-w-4xl mx-auto bg-[#0b314d]/60 p-8 md:p-12 rounded-[2rem] border-2 border-[#D4AF37]/50 shadow-[0_0_30px_rgba(212,175,55,0.2)] backdrop-blur-md relative mt-12">
                        ...
                        <p className="text-lg md:text-2xl leading-loose text-justify urdu-text font-light text-[#fffdf5]">
                            {pageIntro.quote}
                        </p>
                    </div>
                </div>
            ...
            <section className="container mx-auto px-4 py-16 md:py-24" dir="rtl">
                <div className="text-center mb-14">
                    <h2 className="text-3xl md:text-5xl font-bold text-[#0b314d] urdu-text mb-6 flex justify-center items-center gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                    {diplomaticServicesList.map((service, index) => (
                        <div key={index} className="bg-white p-8 md:p-10 rounded-3xl shadow-lg border-t-8 border-[#0b314d] hover:border-[#D4AF37] hover:shadow-2xl transition-all duration-300 group">
                            <h3 className="text-2xl font-bold text-[#0b314d] group-hover:text-[#D4AF37] mb-5 urdu-text transition-colors border-b pb-3 border-gray-100">
                                {service.title}
                            </h3>
                            <p className="text-gray-700 text-lg md:text-xl leading-relaxed urdu-text text-justify">{service.text}</p>
                        </div>
                    ))}
                </div>

                <h3 className="text-3xl font-bold text-[#0b314d] mb-8 urdu-text text-center border-b-2 border-[#D4AF37] pb-3 inline-block mx-auto w-full text-center">سفارتی گیلری</h3>
            ...
            <section className="bg-[#0a1f30] text-white py-16 md:py-24 border-y-8 border-[#D4AF37] relative">
                <div className="container mx-auto px-4 relative z-10" dir="rtl">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold text-[#D4AF37] urdu-text mb-6 flex justify-center items-center gap-4 drop-shadow-lg">
                            <FaMosque className="text-white" /> وحدتِ امت کا تاریخی مشن
                        </h2>
                        <p className="text-xl md:text-2xl text-[#e2e8f0] urdu-text max-w-4xl mx-auto leading-relaxed">بین المسالک و بین المذاہب ہم آہنگی اور قلوب کو جوڑنے کا 25 سالہ سفر</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                        {unityData.efforts.map((effort, i) => (
                            <div key={i} className="bg-[#112a40] p-8 md:p-10 rounded-3xl border border-[#D4AF37]/30 hover:border-[#D4AF37] shadow-lg transition-colors">
                                <h4 className="text-[#D4AF37] font-bold text-2xl mb-4 urdu-text border-b border-[#D4AF37]/20 pb-3">{effort.title}</h4>
                                <p className="text-gray-200 text-lg md:text-xl leading-relaxed text-justify urdu-text">{effort.desc}</p>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-emerald-900 to-[#0b314d] p-8 md:p-14 rounded-[3rem] border-4 border-[#D4AF37] shadow-[0_15px_40px_rgba(0,0,0,0.5)] mb-16">
                        <h3 className="text-3xl md:text-4xl font-bold text-[#D4AF37] mb-6 urdu-text flex items-center gap-4 border-b border-[#D4AF37]/30 pb-4">
                            <FaMedal className="text-4xl" /> {unityData.chadarPoshi.title}
                        </h3>
                        <p className="text-lg md:text-xl leading-relaxed mb-10 text-justify text-white urdu-text">
                            {unityData.chadarPoshi.desc}
                        </p>

                        <div className="bg-[#0a1f30]/60 p-8 md:p-10 rounded-3xl border border-emerald-700/50">
                            <h4 className="text-2xl font-bold text-[#D4AF37] mb-6 urdu-text border-b border-[#D4AF37]/30 pb-3 inline-block">تقریب میں شریک جید علمائے کرام اور معزز شخصیات:</h4>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {unityData.chadarPoshi.scholars.map((scholar, idx) => (
                                    <div key={idx} className="flex items-start gap-3">
                                        <span className="text-[#D4AF37] mt-1 text-lg">✨</span>
                                        <p className="text-lg md:text-xl urdu-text text-[#fff7cc]">{scholar}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="bg-white text-[#0b314d] p-8 md:p-14 rounded-[3rem] shadow-[0_10px_30px_rgba(212,175,55,0.3)] text-center max-w-4xl mx-auto mb-16 border-b-8 border-[#D4AF37]">
                        ...
                        <h3 className="text-3xl md:text-4xl font-bold mb-6 urdu-text">{unityData.embassy.title}</h3>
                        <p className="text-lg md:text-xl leading-relaxed text-gray-800 text-justify urdu-text">{unityData.embassy.desc}</p>
                    </div>

                    <h3 className="text-3xl font-bold text-[#D4AF37] mb-8 urdu-text text-center border-b-2 border-[#D4AF37] pb-3 inline-block mx-auto w-full">وحدت اور ملاقاتوں کی گیلری</h3>
                    <ImageGallery images={galleries.unity} openLightbox={openLightbox} />
                </div>
            </section>

            {/* 🗣️ 4. فارسی زبان کی خدمات (AZFA & Syed Noor) */}
                        ...
                        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl border-t-8 border-[#D4AF37] hover:shadow-2xl transition-all">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                {persianServicesData.projects[1].playlists.map((pl, idx) => (
                                    <a key={idx} href={pl.link} target="_blank" rel="noopener noreferrer" className="flex justify-center items-center gap-3 bg-[#0b314d] text-white px-6 py-4 rounded-xl font-bold hover:bg-[#D4AF37] hover:text-[#0b314d] transition-colors shadow-md text-lg urdu-text">
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
                        ...
                        <div className="bg-gray-50 p-8 md:p-12 rounded-3xl shadow-lg border-r-8 border-[#0b314d]">
                            <h2 className="text-3xl md:text-4xl font-bold text-[#0b314d] mb-8 urdu-text flex items-center gap-4">
                                <FaUsers className="text-[#D4AF37]" /> انجمن دوستی پاکستان و ایران
                            </h2>
                            <p className="text-gray-800 text-lg md:text-xl leading-relaxed text-justify mb-8 urdu-text">{anjumanData.intro}</p>
                            ...
                            <p className="text-gray-800 text-lg md:text-xl leading-relaxed text-justify mb-8 urdu-text">{anjumanData.websiteDesc}</p>
                            <a href="https://pakiiranassociation.wixsite.com/pira" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#0b314d] text-white px-10 py-4 rounded-full font-bold shadow-lg hover:bg-[#D4AF37] hover:text-[#0b314d] transition-all text-lg urdu-text">
                                پاک ایران ویب سائٹ وزٹ کریں
                            </a>
                        </div>
                        ...
                        <div className="bg-gray-50 p-8 md:p-12 rounded-3xl shadow-lg border-l-8 border-[#D4AF37]">
                            ...
                            <p className="text-gray-800 text-lg md:text-xl leading-relaxed text-justify mb-8 urdu-text">{festivalsData.desc}</p>
                            <div className="space-y-6">
                                {festivalsData.events.map((event, idx) => (
                                    <div key={idx} className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-200 hover:border-[#D4AF37] hover:shadow-md transition-all">
                                        <h4 className="text-2xl font-bold text-[#0b314d] mb-3 urdu-text border-b pb-2">{event.title}</h4>
                                        <p className="text-gray-700 text-lg leading-relaxed text-justify urdu-text">{event.text}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="mt-16">
                        <h3 className="text-3xl font-bold text-[#0b314d] mb-8 urdu-text text-center border-b-2 border-[#D4AF37] pb-3 inline-block mx-auto w-full text-center">فیسٹیولز اور تقریبات کی گیلری</h3>
            ...
            <section className="bg-gray-100 py-16 md:py-24 border-t-4 border-[#D4AF37]">
                <div className="container mx-auto px-4" dir="rtl">
                    <h2 className="text-3xl md:text-5xl font-bold text-[#0b314d] mb-12 text-center urdu-text drop-shadow-sm">🎥 سفارتی اور ثقافتی ویڈیوز</h2>
...
function VideoCard({ url, title, setActiveVideo, isCloudinary = false }) {
    ...
    return (
        <div className="relative group rounded-2xl overflow-hidden border-4 border-[#0b314d]/30 hover:border-[#D4AF37] shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer bg-black aspect-video" onClick={() => setActiveVideo(url)}>
            ...
            {/* 🔴 پلے بٹن کو چھوٹا کر کے بائیں کونے (Bottom-Left) میں کر دیا گیا ہے تاکہ تھمب نیل نظر آئے */}
