...
export const BOOKS_DATA = [
 {
    ...
    descUrdu: `یہ ضخیم علمی مجموعہ شبیر احمدشگری کی گزشتہ کئی سالوں کی فکر انگیز صحافت، علمی کاوشوں اور فکری بصیرت کا نچوڑ ہے۔کتاب کے یہ صفحات دورِ حاضر کے سماجی، فکری اور تاریخی حقائق کے ایک معتبر دستاویز ہیں۔قارئین کی سہولت کے لیے اس مجموعے کو نہایت خوبصورتی سے موضوعاتی ابواب (جیسے اسلامی، ثقافتی، شخصیات اور تحقیقی موضوعات) میں تقسیم کیا گیا ہے۔تاریخ اور موضوعات کا یہ حسین امتزاج قاری کو ماضی کے جھروکوں سے لے کر حال کے فکری مباحث تک ایک دلنشین سفر پر لے جاتا ہے۔
یہ ڈیجیٹل ایڈیشن اردو ادب، صحافت اور تحقیق سے وابستہ طلبہ اور سنجیدہ قارئین کے لیے ایک انمول علمی تحفہ ہے۔آپ اس اس کتاب کو باآسان پڑھ بھی سکتے ہیں اور اپنی تحقیق کے لیے استفادہ بھی کر سکتے ہیں۔
...
مصنف: حاجی شبیر احمد شگری`,
    actions: [
      { type: 'read', label: 'کتاب پڑھیں', url: 'https://res.cloudinary.com/dtqrziupt/image/upload/v1777958496/%DA%A9%D8%AA%D8%A7%D8%A8_%DA%A9%D8%B1%D8%A7%D9%85%D8%A7%D8%AA%D9%90_%D8%B1%D8%B6%D9%88%DB%8C__compressed_gonugn.pdf', color: 'theme-read', disabled: false },
      { type: 'audio', label: 'گوگل آڈیو پوڈکاسٹ', url: 'https://res.cloudinary.com/drlg0dr9y/video/upload/v1777964088/Karamat-e-Rizvi-audeo-compressed_jeavyi.mp3', color: 'theme-urdu-aud', disabled: false },
      { type: 'video', label: 'گوگل ویڈیو پوڈکاسٹ', url: 'https://res.cloudinary.com/drlg0dr9y/video/upload/v1777964149/Karamat-e-Rizvi_video_podcast_compressed_a5zih7.mp4', color: 'theme-urdu-vid', disabled: false }
    ]
  },
  {
    id: 'book-booy',
