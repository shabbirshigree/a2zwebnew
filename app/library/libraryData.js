export const AUTHOR_REVIEW = {
  ...
  audioUrl: "https://res.cloudinary.com/dtqrziupt/video/upload/v1772595285/%D8%B3%DA%A9%D8%B1%D8%AF%D9%88_%DA%A9%DB%92_%D9%BE%DB%81%D8%A7%DA%91%D9%88%DA%BA_%D8%B3%DB%92_%D9%88%DB%8C%DA%98%D9%88%D9%84_%D9%82%D8%B1%D8%A2%D9%86_%D8%AA%DA%A9_qsc6gs.mp4",
...
export const BOOKS_DATA = [
{
    ...
    actions: [
      { 
        type: 'read', 
        label: 'کتاب پڑھیں', 
        url: 'https://res.cloudinary.com/dtqrziupt/image/upload/v1772638934/boey-behesht..compressed_qan3jl.pdf', 
        color: 'theme-read', 
        disabled: false 
      },
      { 
        ...
        url: 'https://res.cloudinary.com/dtqrziupt/video/upload/v1772587962/boey-behisht-audeo-podcast_ynq9uq.mp3', 
  ...
  },
  {
    ...
    badge: 'SPIRITUALITY',
    orientation: 'portrait',
    descUrdu: 'امام رضا علیہ السلام کے مرقدِ منور اور ان کی روحانی تعلیمات کا ایک خوبصورت تذکرہ۔',
    actions: [
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/dtqrziupt/image/upload/v1772651728/eb2e1ccd-e669-4453-8ca7-10f38cf13a50.png', // تصویر کا لنک ٹھیک کر دیا گیا
    badge: 'TRAVEL & CULTURE',
    orientation: 'portrait',
    descUrdu: 'حاجی شبیر احمد شگری کی یہ کتاب محض ایک سفرنامہ نہیں، بلکہ ایران کے تاریخی، مذہبی اور ثقافتی مقامات کا ایک جامع جائزہ ہے۔',
    actions: [
  ...
  },
  {
    ...
    orientation: 'portrait',
    descUrdu: 'انسان کی روحانی ترقی، عبادات کے اسرار اور روح کی معراج کے حوالے سے ایک گراں قدر تصنیف۔',
    actions: [
  ...
  },
  {
    id: 'book-sakoon',
    title: 'سکون کی تلاش',
    image: 'https://res.cloudinary.com/dtqrziupt/image/upload/v1772651897/e56ab798-14ec-4aaf-a0b3-a205a1aae1f4.png', // تصویر کا لنک ٹھیک کر دیا گیا
    badge: 'PEACE & MIND',
    orientation: 'portrait',
    descUrdu: 'آج کے پرفتن اور بے سکون دور میں قلبی اور ذہنی سکون حاصل کرنے کے اسلامی اور روحانی اصول۔',
    actions: [
  ...
  },
{
    ...
    badge: 'SUPABASE FILE',
    orientation: 'portrait',
    descUrdu: 'ایران کی مکمل ثقافتی اور جغرافیائی سیر۔ (نوٹ: یہ فائل سپا بیس سرور سے براہِ راست لوڈ ہوگی)۔',
    actions: [
      { 
        type: 'read', 
        label: 'حصہ اول پڑھیں', 
        url: 'https://bktkwypcufsmdpvueotw.supabase.co/storage/v1/object/public/books/sayahat-e-iran1_compressed.pdf', 
        color: 'theme-read', 
        disabled: false 
      },
      { 
        type: 'read', 
        label: 'حصہ دوم پڑھیں', 
        url: 'https://bktkwypcufsmdpvueotw.supabase.co/storage/v1/object/public/books/sayahat-e-iran2_compressed.pdf', 
        color: 'theme-read', 
        disabled: false 
      },
      { 
        type: 'audio', 
        label: 'گوگل آڈیو پوڈکاسٹ', 
        url: 'https://res.cloudinary.com/dtqrziupt/video/upload/v1769065454/%D8%A7%DB%8C%D8%B1%D8%A7%D9%86_%DA%A9%DB%8C_%D9%85%D8%B2%D8%A7%D8%AD%D9%85%D8%AA_%D8%A7%D9%88%D8%B1_%D9%85%D8%B4%DB%81%D8%AF_%DA%A9%D8%A7_%D8%B3%D9%81%D8%B1_giowyp.mp4', 
        color: 'theme-urdu-aud', 
        disabled: false 
      },
      { 
        type: 'video', 
        label: 'گوگل ویڈیو پوڈکاسٹ', 
        url: 'https://res.cloudinary.com/dtqrziupt/video/upload/v1769034696/%D8%B3%DB%8C%D8%A7%D8%AD%D8%AA%D9%90_%D8%A7%DB%8C%D8%B1%D8%A7%D9%86_%D9%88%DA%88%DB%8C%D9%88_%D8%AA%D8%AC%D8%B2%DB%8C%DB%81_tctlnm.mp4', 
        color: 'theme-urdu-vid', 
        disabled: false 
      }
    ]
  },
  {
    ...
    badge: 'LANDSCAPE BOOK',
    orientation: 'landscape', 
    descUrdu: 'روحانی ترقی اور مشکلات کے حل کے لیے انتہائی مجرب دعاؤں کا مجموعہ ہے۔',
    actions: [
  ...
  },
  {
    ...
    badge: 'SUPABASE STORAGE', // یہاں ہم نے بیج کو اپڈیٹ کر دیا ہے
    orientation: 'portrait',
    descUrdu: 'یہ ایک شاندار تصویری کتاب ہے جس کی مکمل ڈیزائننگ خاکسار نے کی۔ اس میں خراسان کے تاریخی مقامات کو پیش کیا گیا ہے۔', 
    actions: [
      { 
        type: 'read', 
        source: 'supabase', 
        label: 'حصہ اول پڑھیں', 
        icon: 'book', 
        url: 'https://bktkwypcufsmdpvueotw.supabase.co/storage/v1/object/public/books/khorasan-razavi-1_compressed.pdf', 
        color: 'theme-read', 
        disabled: false 
      },
      { 
        ...
        label: 'حصہ دوم پڑھیں', 
        icon: 'book', 
        url: 'https://bktkwypcufsmdpvueotw.supabase.co/storage/v1/object/public/books/khorasan-razavi-2_compressed.pdf', 
        color: 'theme-read', 
        disabled: false 
      },
      { 
  ...
  },
  {
    ...
    badge: 'SUPABASE FILE',
    orientation: 'portrait',
    descUrdu: 'رہبرِ معظم آیت اللہ سید علی خامنہ ای کے اہم فتاویٰ کا مستند مجموعہ، جو مومنین کی روزمرہ شرعی رہنمائی کے لیے ترتیب دیا گیا ہے۔',
    actions: [
      { 
        type: 'read', 
        label: 'حصہ اول پڑھیں', 
        url: 'https://bktkwypcufsmdpvueotw.supabase.co/storage/v1/object/public/books/rehbar-k-fatawa1_compressed.pdf', 
        color: 'theme-read', 
        disabled: false 
      },
      { 
        type: 'read', 
        label: 'حصہ دوم پڑھیں', 
        url: 'https://bktkwypcufsmdpvueotw.supabase.co/storage/v1/object/public/books/rehbar-k-fatawa2_compressed.pdf', 
        color: 'theme-read', 
        disabled: false 
      },
      { 
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/dtqrziupt/image/upload/v1768016581/Majala-Farhangistan_xdsc1a.png', // تصویر کا لنک ٹھیک کر دیا گیا
