    ...
    <div className="min-h-screen bg-[#f8f9fa] text-gray-800 font-sans">
      ...
      <section className="bg-gradient-to-b from-[#0b314d] to-[#0f4c75] text-white py-12 md:py-16 text-center relative border-b-4 border-[#D4AF37] shadow-xl">
         ...
         <div className="container mx-auto px-4 relative z-10">
            ...
            <h2 className="text-xl md:text-2xl text-[#fff7cc] font-light urdu-text tracking-widest">
              {unityIntro.subtitle}
            </h2>
      ...
      <section className="container mx-auto px-4 py-10 md:py-16" dir="rtl">
        <div className="bg-white rounded-2xl shadow-lg border-t-4 border-[#D4AF37] p-6 md:p-10 mb-12 relative overflow-hidden">
           ...
           <p className="text-lg md:text-2xl text-[#0b314d] leading-loose urdu-text font-medium text-justify drop-shadow-sm italic">
             {unityIntro.quote}
           </p>
        </div>
        ...
        <div className="space-y-8">
          {unityEfforts.map((effort, index) => (
            <div key={index} className="bg-white p-6 md:p-8 rounded-2xl shadow-md border-r-4 border-[#D4AF37] hover:shadow-lg transition-all duration-300">
              <h3 className="text-xl md:text-2xl font-bold text-[#0b314d] mb-3 urdu-text">
                {effort.title}
              </h3>
              <p className="text-gray-700 text-sm md:text-lg leading-relaxed urdu-text text-justify font-light">
                {effort.desc}
              </p>
            </div>
          ))}
      ...
      <section className="bg-[#0b314d] text-white py-12 md:py-16 border-y-4 border-[#D4AF37] relative">
        ...
        <div className="container mx-auto px-4 relative z-10" dir="rtl">
          <h2 className="text-2xl md:text-4xl font-bold text-[#D4AF37] mb-8 text-center urdu-text drop-shadow-md">
            {chadarPoshiData.title}
          </h2>
          <div className="bg-white/10 p-6 md:p-10 rounded-2xl border border-[#D4AF37]/50 backdrop-blur-sm mb-10">
            <p className="text-sm md:text-lg leading-relaxed urdu-text font-light text-justify italic mb-8">
              {chadarPoshiData.desc}
            </p>
            <h3 className="text-xl md:text-2xl font-bold text-[#D4AF37] border-b border-[#D4AF37]/30 pb-2 mb-6 urdu-text inline-block">
      ...
      <section className="bg-gray-50 py-12 md:py-16">
        <div className="container mx-auto px-4" dir="rtl">
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-6 md:p-12 mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0b314d] mb-6 urdu-text border-b-2 border-[#D4AF37] pb-3 inline-block">
              {embassyMeetingData.title}
            </h2>
            <p className="text-gray-700 text-sm md:text-lg leading-relaxed urdu-text text-justify mb-8 font-light">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {embassyMeetingData.points.map((point, i) => (
                <div key={i} className="bg-gray-50 p-6 rounded-xl border-t-4 border-[#0b314d] shadow-sm">
                  <h4 className="text-lg font-bold text-[#D4AF37] mb-3 urdu-text">{point.title}</h4>
                  <p className="text-gray-700 text-sm md:text-base leading-relaxed urdu-text text-justify">{point.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-6 md:p-12 border-r-8 border-r-[#D4AF37]">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0b314d] mb-6 urdu-text">
              {ahnafConferenceData.title}
            </h2>
            <div className="space-y-4 text-gray-700 text-sm md:text-lg leading-relaxed urdu-text text-justify font-light">
      ...
      {/* 🎥 🔴 نیا سیکشن: ویڈیو گیلری */}
      <section className="container mx-auto px-4 py-12">
        <h2 className="text-2xl md:text-4xl font-bold text-[#0b314d] mb-10 text-center urdu-text border-b-2 border-[#D4AF37] pb-3 inline-block mx-auto w-full">🎥 وحدتِ امت (ویڈیوز اور کوریج)</h2>
      ...
      <section className="container mx-auto px-4 py-12 border-t border-[#D4AF37]/30">
        <h2 className="text-2xl md:text-4xl font-bold text-[#0b314d] mb-10 text-center urdu-text">📸 وحدتِ امت اور ملاقاتوں کی جھلکیاں</h2>
...
// 🎨 ہیلپر کمپوننٹ (ویڈیو کارڈ کے لیے)
function VideoCard({ url, title, setActiveVideo, isCloudinary = false }) {
  const videoId = !isCloudinary ? getYouTubeId(url) : null;
  
  // 🔴 جادوئی ٹرک: کلاؤڈ نری ویڈیو کے لنک (.mp4) کو خودکار طور پر تصویر (.jpg) میں بدل کر دکھانا
