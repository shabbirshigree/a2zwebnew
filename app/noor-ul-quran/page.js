...
import { quranVideos } from './noor-ul-quranData';
    ...
    <main className="min-h-screen bg-[#050505] text-white overflow-x-hidden font-sans">
      ...
      <section className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#0f2a40] via-[#050505] to-[#000000] py-12 md:py-16 text-center relative border-b border-[#D4AF37]/20">
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-4xl md:text-6xl font-extrabold text-[#D4AF37] urdu-text mb-3 tracking-wide">نور القرآن پراجیکٹ</h1>
      ...
      <section className="bg-gradient-to-b from-black to-[#0b314d] py-16 md:py-20 border-y-4 border-[#D4AF37]/50">
        <div className="container mx-auto px-4" dir="rtl">
          <div className="max-w-4xl mx-auto bg-white/5 p-8 md:p-12 rounded-3xl border border-[#D4AF37]/30 text-center shadow-lg relative overflow-hidden">
            ...
            <p className="text-white/90 text-base md:text-xl leading-relaxed urdu-text font-light mb-8">اگر آپ اس عالمی صدقہ جاریہ میں حصہ ڈالنا چاہتے ہیں تو ہم سے رابطہ فرمائیں۔</p>
      ...
      <div className="bg-black">
        ...
        <section id="tilawat" className="py-8 px-4 border-t border-white/5 max-w-6xl mx-auto">
          <h3 className="bg-[#0b314d] text-[#D4AF37] px-6 py-2 rounded-full border border-[#D4AF37]/50 urdu-text text-xl font-bold text-center mb-8">تلاوت، نعت اور معجزہ قرآن</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
