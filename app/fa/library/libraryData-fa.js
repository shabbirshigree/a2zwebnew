...
export const BOOKS_DATA = [
{
    ...
    descUrdu: `این مجموعه حجیم علمی، چکیده‌ای از روزنامه‌نگاری تفکربرانگیز، تلاش‌های علمی و بینش فکری حاجی شبیر احمد شگری در طول سالیان گذشته است. صفحات این کتاب سند معتبری از واقعیت‌های اجتماعی، فکری و تاریخی دوران معاصر به شمار می‌روند. برای رفاه حال خوانندگان، این مجموعه به شکلی زیبا در فصل‌های موضوعی (مانند موضوعات اسلامی، فرهنگی، شخصیتی و پژوهشی) دسته‌بندی شده است. این ترکیب دلنشین از تاریخ و موضوعات، خواننده را از دریچه‌ی گذشته تا مباحث فکری حال، به سفری جذاب می‌برد.
این نسخه‌ی دیجیتال، هدیه‌ای ارزشمند و علمی برای دانشجویان و خوانندگان جدی حوزه‌ی ادبیات، روزنامه‌نگاری و پژوهش است. شما می‌توانید این کتاب را به راحتی مطالعه کرده و برای پژوهش‌های خود از آن بهره‌مند شوید.
