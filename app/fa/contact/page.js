...
export default function FarsiContact() {
    ...
    return (
        <main className="min-h-screen bg-[#fcfdfe] overflow-x-hidden font-sans" dir="rtl">
            <Navbar />
            <HeroSlider />
            ...
            <section className="bg-[#0b314d] py-16 md:py-24 text-center relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
                    <h1 className="text-5xl md:text-7xl font-extrabold text-[#D4AF37] mb-4 drop-shadow-2xl">تماس با ما</h1>
                    <div className="w-32 h-1.5 bg-gradient-to-r from-transparent via-[#D4AF37] to-transparent mx-auto rounded-full mb-6"></div>
                    <p className="text-[#fff7cc] text-xl md:text-2xl font-light tracking-widest opacity-90 max-w-3xl text-center">
                        به طور مستقیم با ما ارتباط برقرار کنید
                    </p>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
                    {contactMethods.map((method, i) => (
                        <a
                            key={i}
                            href={method.link}
                            target={method.title === "مکان" ? "_blank" : "_self"}
                        ...
                        >
                            <div className="absolute top-0 right-0 w-24 h-24 bg-[#D4AF37] rounded-bl-full opacity-10 group-hover:opacity-20 transition-all duration-500" />
                            ...
                            <h3 className="text-xl md:text-2xl font-bold text-[#0b314d] mb-3 text-center">{method.title}</h3>
            ...
            <section className="container mx-auto px-4 py-12 md:pb-24">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    <div className="bg-[#0b314d] rounded-[3rem] p-8 md:p-12 shadow-2xl relative overflow-hidden border-t-8 border-b-8 border-[#D4AF37]">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-[#D4AF37] mb-8 text-center relative z-10 drop-shadow-md">
                            لطفاً پیام خود را ارسال کنید
                        </h2>
                        <form action="https://formsubmit.co/shigri51214@gmail.com" method="POST" className="space-y-6 relative z-10" dir="rtl">
                            <input type="hidden" name="_subject" value="پیام جدید از وب‌سایت" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <input
                                    ...
                                    placeholder="نام شما"
                                    required
                                    className="w-full bg-white/5 border border-white/20 rounded-2xl px-6 py-4 text-white placeholder-gray-400 focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] focus:outline-none transition-all"
                                />
                                <input
                                    type="email"
                                    name="email"
                                    ...
                                    required
                                    className="w-full bg-white/5 border border-white/20 rounded-2xl px-6 py-4 text-white placeholder-gray-400 focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] focus:outline-none text-right transition-all"
                                />
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <input
                            ...
                            <textarea
                                ...
                                required
                                rows="5"
                                className="w-full bg-white/5 border border-white/20 rounded-2xl px-6 py-4 text-white placeholder-gray-400 focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] focus:outline-none resize-none transition-all"
                            />
                            <button
                                type="submit"
                                className="w-full bg-gradient-to-r from-[#D4AF37] to-[#B8860B] text-[#0b314d] font-bold py-4 rounded-2xl hover:shadow-[0_10px_20px_rgba(212,175,55,0.4)] transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3 text-xl md:text-2xl"
                            >
                                <FaPaperPlane className="transform -rotate-45" /> ارسال پیام
                            </button>
                        </form>
                    </div>
