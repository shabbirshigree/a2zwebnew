export const ghaziData = {
  intro: {
    welcome: "خوش آمدید به صفحه رسمی صدای غازی",
    heroTitle: "جایزه صدای غازی",
    heroSubtitle: "حاجی شبیر احمد شیگری - خادم و محافظ حرم حضرت غازی عباس (ع)",
