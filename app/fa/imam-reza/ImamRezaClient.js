...
export default function ImamRezaClient() {
  ...
  const handleShare = (e, vid) => {
    ...
    if (navigator.share) {
      navigator.share({
        title: vid.title,
        text: `این ویدیو را ببینید: ${vid.title}`,
        url: shareUrl,
      }).catch(() => {});
    } else {
  ...
  return (
    <main className="min-h-screen bg-[#f8f9fa] text-gray-800 relative overflow-hidden font-amiri" dir="rtl">
      <Navbar />
      ...
      <div className="absolute top-20 md:top-24 right-4 z-[60] flex gap-3">
         ...
         <Link href="/fa/" className="bg-white text-[#D4AF37] p-2 rounded-full shadow-lg border-2 border-[#D4AF37] hover:scale-110 transition-transform"><FaArrowRight size={18} /></Link>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 pt-16 pb-8 text-center">
        <div className="bg-white/80 backdrop-blur-md border-2 border-[#D4AF37] rounded-[2rem] p-6 md:p-10 shadow-xl max-w-5xl mx-auto animate-float">
           ...
           <h1 className="text-2xl md:text-5xl font-extrabold text-[#0f4c75] mb-2 font-extra-bold">حاجی شبیر احمد شگری — خادم امام رضا (ع)</h1>
           <h2 className="text-lg md:text-2xl text-[#D4AF37] font-bold">سفری معنوی از ایمان، خدمت و وظیفه فرهنگی</h2>
           ...
           <div className="text-gray-900 text-sm md:text-xl leading-loose text-justify md:text-center max-w-4xl mx-auto space-y-4 font-extra-bold">
             <p className="font-extrabold text-[#0f4c75] text-lg md:text-2xl">«جایی که پادشاهان و حاکمان سر تعظیم فرود می‌آورند، این محفلی محترم است...»</p>
             <p>به صفحه اختصاصی خدمت و رسالت معنوی در آستان قدس رضوی خوش آمدید. این صفحه نمایشگر سفر باشکوه حاجی شبیر احمد شگری در معرفی میراث زیبا، عشق مذهبی و خدمت فرهنگی است.</p>
             <p className="bg-[#f8f9fa] p-4 rounded-xl border-r-4 border-[#D4AF37] shadow-sm"><strong className="text-[#0f4c75] text-lg">اولین نور: «ضریح نور» (۲۰۰۲)</strong><br />در سال ۲۰۰۲، ایشان ساخت ضریح مطهر فعلی را مستند کردند. در سال ۲۰۱۱، آستان قدس رضوی لقب <strong className="text-[#D4AF37]">«خادم امام رضا»</strong> را به ایشان اعطا کرد.</p>
           </div>
        </div>
      </div>
      ...
      <div id="docs" className="relative z-10 container mx-auto px-4 py-10">
         <div className="text-center mb-8"><h2 className="text-2xl md:text-3xl font-extrabold text-[#0f4c75] border-b-4 border-[#D4AF37] inline-block pb-2">مستندها و ویدیوهای ویژه</h2></div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {tabarrukatVideos.map((vid, idx) => (
               <div key={idx} onClick={() => setActiveVideo(vid.link)} className="bg-white p-6 rounded-2xl shadow-lg border-2 border-[#D4AF37] flex flex-col items-center gap-3 cursor-pointer hover:scale-105 transition-transform group text-center relative">
                  ...
                  <span className="text-sm text-gray-500 font-bold">تماشا</span>
      ...
      <div id="programs" className="relative z-10 container mx-auto px-4 py-10">
         <div className="text-center mb-8"><h2 className="text-2xl md:text-3xl font-extrabold text-[#0f4c75] border-b-4 border-[#D4AF37] inline-block pb-2">برنامه‌های حرم و زیارت زنده</h2></div>
      ...
      {liveParticipationVideos.length > 0 && (
          <div id="liveParticipations" className="relative z-10 container mx-auto px-4 py-10 bg-[#0f4c75]/5 border-y-4 border-[#D4AF37] my-8">
             <div className="text-center mb-8"><h2 className="text-2xl md:text-3xl font-extrabold text-[#0f4c75] border-b-4 border-[#D4AF37] inline-block pb-2">حضور در برنامه‌های زنده</h2></div>
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                {liveParticipationVideos.map((vid, idx) => (
                   <div key={idx} onClick={() => setActiveVideo(vid.link)} className="bg-white p-6 rounded-2xl shadow-xl border border-gray-200 flex flex-col items-center gap-4 cursor-pointer hover:-translate-y-2 hover:shadow-2xl transition-all group text-center relative">
                      ...
                      <span className="bg-[#D4AF37] text-white px-4 py-1 rounded-full text-xs font-bold mt-2">تماشا</span>
                      <button onClick={(e) => handleShare(e, vid)} className="absolute top-4 left-4 text-gray-400 hover:text-[#D4AF37] transition-colors"><FaShareAlt size={18} /></button>
                   </div>
                ))}
             </div>
      ...
      <div id="services" className="relative z-10 container mx-auto px-4 py-12 bg-white">
         <div className="text-center mb-10"><h2 className="text-2xl md:text-3xl font-extrabold text-[#0f4c75] border-b-4 border-[#D4AF37] inline-block pb-2">خدمات آنلاین و وبینارها</h2></div>
         <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-2xl border-2 border-[#D4AF37] overflow-hidden flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 p-8 flex flex-col justify-center space-y-4">
               <h3 className="text-2xl font-extrabold text-[#0f4c75] leading-tight">راه حسینی و نبرد ۱۲ روزه حق و باطل</h3>
               <p className="text-gray-600 font-bold border-b pb-2">نشستی ویژه با همکاری آستان قدس رضوی و نور پروداکشنز.</p>
               <div className="space-y-3 mt-2">
                  <div className="flex items-center gap-3 text-gray-700"><FaCalendarCheck className="text-[#D4AF37] text-xl" /><span className="font-bold">تاریخ: چهارشنبه، ۳۰ جولای ۲۰۲۵</span></div>
                  <div className="flex items-center gap-3 text-gray-700"><FaClock className="text-[#D4AF37] text-xl" /><span className="font-bold">زمان: ۱۵:۳۰ تا ۱۶:۳۰</span></div>
                  <div className="flex items-center gap-3 text-gray-700"><FaLaptop className="text-[#D4AF37] text-xl" /><span className="font-bold">مکان: آنلاین (لینک ویدیو)</span></div>
               </div>
            </div>
         </div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 text-center bg-[#f8f9fa] mt-10 border-t-2 border-[#D4AF37]/30">
         ...
         <div className="flex flex-col md:flex-row justify-center gap-6 max-w-5xl mx-auto">
            ...
            <Link href="/fa/article" className="flex-1 bg-[#D4AF37] text-white p-5 rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all flex items-center justify-center gap-3 font-bold text-lg">
              <FaPenNib size={28} /> همه مقالات و یادداشت‌ها
            </Link>
         </div>
      </div>
      ...
      {activeVideo && (
        <div className="fixed inset-0 z-[100] bg-black/95 flex items-center justify-center p-4 backdrop-blur-md">
          <button onClick={() => {
            setActiveVideo(null);
            router.push('/fa/imam-reza', { scroll: false });
