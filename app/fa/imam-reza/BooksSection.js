...
export default function BooksSection({ setActiveVideo }) {
  ...
  return (
    <div id="books" className="relative z-10 container mx-auto px-4 py-10 bg-white border-t-8 border-[#D4AF37]">
         <div className="text-center mb-8"><h2 className="text-2xl md:text-3xl font-extrabold text-[#0f4c75] border-b-4 border-[#D4AF37] inline-block pb-2">کتاب‌ها و رسائل</h2></div>
