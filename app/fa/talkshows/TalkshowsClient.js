...
function TalkshowsContentFA() {
    ...
    const handleShare = (vid) => {
        ...
        const shareText = `*${vid.title}*\n\nبرای مشاهده این ویدیو اختصاصی نور پروداکشنز روی لینک زیر کلیک کنید 👇\n\n${shareUrl}`;
        ...
        <div className="min-h-screen bg-[#f8f9fa] text-gray-800 font-sans" dir="rtl">
            ...
            <section className="bg-gradient-to-b from-[#0b314d] to-[#0f4c75] text-white py-12 md:py-16 text-center relative border-b-4 border-[#D4AF37] shadow-xl">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <span className="bg-[#D4AF37] text-[#0b314d] font-bold px-4 py-1 rounded-full text-sm md:text-base mb-4 inline-block shadow-lg">ارائه تاریخی نور پروداکشنز</span>
            ...
            <section className="container mx-auto px-4 py-16">
                <h2 className="text-2xl md:text-4xl font-bold text-[#0b314d] mb-12 text-center">سایر پلتفرم‌ها و کانال‌های ما</h2>
                    ...
                    {otherChannels.map((channel, idx) => (
                        <div key={idx} className="relative transition-all duration-300 hover:-translate-y-2 h-full">
                            ...
                            <div className="bg-white rounded-[2rem] p-6 shadow-lg border-2 border-[#D4AF37] h-full flex flex-col items-center text-center relative overflow-hidden group transition-all duration-500 hover:shadow-[0_0_20px_rgba(212,175,55,0.3)]">
                                ...
                                <div className={`mt-auto w-full py-2.5 rounded-xl font-bold text-white text-sm shadow-md bg-gradient-to-r ${channel.color} transition-transform group-hover:scale-105`}>بازدید</div>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <section className="container mx-auto px-4 py-12">
                <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200">
                    ...
                    <div className="p-8 md:p-12 text-gray-700 text-lg md:text-xl leading-loose space-y-6 text-justify">
            ...
            <section className="bg-[#0b314d] py-12 md:py-16 relative border-y-4 border-[#D4AF37]">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-[#D4AF37] mb-6">🎬 گالری ویدیویی نور پروداکشنز</h2>
                            ...
                            categories.map(cat => {
                                ...
                                return (
                                    <div key={cat} className="mb-12">
                                        <h3 className="text-2xl md:text-3xl font-bold text-[#D4AF37] mb-6 border-b-2 border-white/20 pb-2 inline-block pr-6">
                                            {cat}
                                        </h3>
                    ...
                    <div className="flex justify-center mt-8 mb-10">
                        ...
                        >
                            مشاهده ویدیوهای بیشتر <FaChevronDown />
                        </button>
                    </div>
                    ...
                    <div className="flex justify-center mt-8 border-t border-white/20 pt-8">
                        ...
                        >
                            ...
                            برای مشاهده ویدیوهای کامل از کانال یوتیوب نور پروداکشنز دیدن کنید
                        </a>
                    </div>
...
<section className="bg-white py-16 border-t">
  <div className="container mx-auto">
    <Gallery 
      title="🎙️ مصاحبه با شخصیت‌های مهم" 
            ...
            <section className="container mx-auto px-4 pb-16 pt-10">
                <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#0b314d] to-[#0f4c75] rounded-3xl p-8 md:p-12 text-white border-2 border-[#D4AF37] shadow-2xl text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <h2 className="text-2xl md:text-4xl font-bold mb-3 text-[#D4AF37]">ما را دنبال کنید</h2>
                        <p className="text-sm md:text-xl mb-8 opacity-90 font-light">برای تمام آپدیت‌های جدید و محتوای اختصاصی در رسانه‌های اجتماعی به ما بپیوندید</p>
...
export default function TalkshowsPageFA() {
    return (
